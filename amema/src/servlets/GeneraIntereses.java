...
/**
 * Servlet implementation class Intereses
 */
@WebServlet(urlPatterns = {"/GeneraIntereses"}, name="GeneraIntereses")
public class GeneraIntereses extends HttpServlet {
	...
	//METODOS PRIMARIOS
		...
		private void generaInteres(HttpServletRequest req) throws ApplicationException, ParseException {		
			...
			Date fecMov = df.parse(req.getParameter("fecMovimiento"));

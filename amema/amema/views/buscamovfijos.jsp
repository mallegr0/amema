...
<body>
	...
	<div class="w3-container w3-padding-64 w3-card-4">
		<br>
		<h2 class="w3-center  w3-text-indigo">Consulta de Socios</h2>
		<div class="w3-container w3-card-4">
			<%@ include file="../forms/movfijos/buscarMovFijosForm.jsp"%>
		</div>
		<br>
		<%if(request.getSession().getAttribute("lista") != null) {%>
			<div class="w3-container w3-card-4">
				<br>
				<%@ include file="../forms/movfijos/seleccionarSMovFijosForm.jsp"%>
			</div>
		<%}
		else {%> 

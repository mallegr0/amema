...
<form action="/amema/Usuario" name ="Usuario" method="post">
	<div class="w3-container">
		...
		<div class="w3-row w3-section">
			<div class="w3-half w3-center"><button class="w3-button w3-green w3-hover-indigo" name="evento_alta">Agregar</button></div>
			<div class="w3-rest w3-center"><a href="../views/usuarios.jsp" class="w3-button w3-red">Volver</a></div>
		</div>
	</div>
</form>
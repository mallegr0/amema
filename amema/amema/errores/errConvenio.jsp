	...
	if(msj != null){
		...
		switch(msj){
			case "siAlta": clase = "w3-pale-green";
						   titulo = "Éxito";
						   msg = "El convenio ha sido creado correctamente";
						   break;
			case "noAlta": clase = "w3-pale-red";
		   				   titulo = "Fracaso";
		   				   msg = "El convenio no se ha podido crear";
		   				   break;
		   
		    case "siBaja": clase = "w3-pale-green";
		                   titulo = "Éxito";
		                   msg = "El convenio ha sido eliminado correctamente";
		                   break;
		    case "noBaja": clase = "w3-pale-red";
			    	       titulo = "Fracaso";	
			               msg = "El convenio no se ha podido eliminar";
						   break;
			case "siModifica": clase = "w3-pale-green";
						       titulo = "Éxito";
							   msg = "El convenio ha sido modificado correctamente";
						       break;
			case "noModifica": clase = "w3-pale-red";
			                   titulo = "Fracaso";
			                   msg = "El convenio no se ha podido modificar";
			                   break;
			}%>
